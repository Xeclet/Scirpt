...
local win = Flux:Window("NinjaLegend", "SecretHub", Color3.fromRGB(0, 255, 62 ), Enum.KeyCode.LeftControl)
local tab = win:Tab("Farm", "http://www.roblox.com/asset/?id=6023426915")

tab:Toggle("Auto-Farm Ninjitsu", "Automatically Ninjitsu for you!", false, function(t)
_G.on = t
...
local tab = win:Tab("Misc", "http://www.roblox.com/asset/?id=6022668888")
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(144.021057, 79855.3984, 88.9619141, 0.342042685, -0, -0.939684391, 0, 1, -0, 0.939684391, 0, 0.342042685)
